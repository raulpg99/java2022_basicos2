...
public class NotasMain {
	...
	public static void main(String[] args) {
		...
		do {
			mostrarMenu();
			opcion=sc.nextInt();//se introduce la opcion elegida para evaluarla en el switch
			switch (opcion) {
			    case 1:
			    	pedirNota();
				    break;
	...
	static void mostrarAprobados() {
		System.out.println("el numero de aprobados es: "+notasService.aprobados());
	}
	static void mostrarExtremas() {
		System.out.println("la nota maxima es: "+notasService.notaMax());
		System.out.println("la nota minima es: "+notasService.notaMin());
	}
